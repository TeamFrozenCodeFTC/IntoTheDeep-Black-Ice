...
//import org.firstinspires.ftc.teamcode.blackIce.paths.segments.Line;
//import org.firstinspires.ftc.teamcode.blackIce.paths.segments.PathGeometry;
//
...
//    private final PathBehaviorModifier defaultPathBehavior;
//    private final ArrayList<PathGeometry> segments = new ArrayList<>();
//
//    public SegmentSequenceBuilder(Vector startingPose, PathBehaviorModifier defaultPathBehavior) {
//        this.defaultPathBehavior = defaultPathBehavior;
//        this.previousTargetPoint = startingPose;
//    }
//
//    public Path build() {
//        Path path = new Path(segments.toArray(new PathGeometry[0]));
...
//        Line segment = new Line(previousTargetPoint, point);
//        segments.add(segment);
