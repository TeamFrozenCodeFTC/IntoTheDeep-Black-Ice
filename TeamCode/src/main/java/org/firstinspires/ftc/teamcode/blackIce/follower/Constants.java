...
import org.firstinspires.ftc.teamcode.blackIce.robot.drivetrain.MecanumDriveConstants;
...
public class Constants {
    public static FollowerConstants.Builder createFollowerConstants(OpMode opMode) {
        return new FollowerConstants.Builder()
            .localizer(new PinpointLocalizer(opMode.hardwareMap, DistanceUnit.INCH))
            .drivetrain(new MecanumDrive(opMode.hardwareMap, new MecanumDriveConstants()
                ...
                .maxForwardSpeed(60)
                .maxLateralSpeed(45)))
            .headingPIDF(new PIDFController(2, 0, 0, 0))
