...
// */
//public class PathBehaviorOld<T extends PathBehaviorOld<T>> {
//    // TODO make this stuff final
//
...
//    private VelocityProfile motionProfile;
//
//    private boolean preventReverseDeceleration = true;
//    private boolean decelerateWithZeroPower = false;
//    private boolean decelerateWithoutFeedforward = true;
//
...
//
//    public PathBehaviorOld(PathBehaviorOld<?> copyFrom) {
...
//     */
//    public T preventReverseDeceleration(boolean preventReverseDeceleration) {
//        this.preventReverseDeceleration = preventReverseDeceleration;
//        return getThis();
//    }
//
////    /**
...
////     */
////    public T decelerateWithZeroPower(boolean decelerateWithZeroPower,
////                                     double distance) {
////        this.decelerateWithZeroPower = decelerateWithZeroPower;
////        this.deceleration = () -> Kinematics.computeDecelerationToStop(distance);
////        return getThis();
////    }
//
//    protected T setConstraint(Consumer<PathBehaviorOld<?>> setter) {
//        setter.accept(this);
//        return getThis();
//    }
...
//        return getThis();
//    }
//    // TODO setDecelerationSeconds, setDecelerationDistance
//
//    public T setDecelerationFromSeconds(double seconds) {
//        stopAtEnd();
//        this.deceleration = maxVelocity/seconds; // should be lambda
//        // 60 inches/s in 2 seconds will decelerate at 30inches/s/s
//        rebuildLinearMotionProfile();
//        return getThis();
//    }
//
...
//     * path.
//     */
//    public T setMotionProfile(VelocityProfile motionProfile) {
...
//        motionProfile = new TrapezoidalVelocityProfile(
//            acceleration,
//            maxVelocity,
//            deceleration,
//            endingVelocity,
...
//        nullifyLinearMotionProfile();
//        this.motionProfile = VelocityProfile.maximizeSpeed;
//        return getThis();
//    }
//
...
//        return stopAtEnd;
//    }
//    public VelocityProfile getMotionProfile() {
...
//    }
//
//    public boolean doesPreventReverseDeceleration() {
//        return preventReverseDeceleration;
//    }
//
//    public boolean doesDecelerateWithZeroPower() {
//        return decelerateWithZeroPower;
//    }
//}
