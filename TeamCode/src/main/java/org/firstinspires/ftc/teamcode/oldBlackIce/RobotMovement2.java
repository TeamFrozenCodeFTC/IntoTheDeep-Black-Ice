...
//
//
//public abstract class RobotMovement2 extends Robot {
//    final int TILE = 24;
//    final int ROBOT = 18;
...
//    }
//
//    private void stopAtPosition(double heading, double x, double y, ErrorMargin errorMargin) {
//        setTarget(heading, x, y);
//
...
//                (totalDistanceToTarget - distanceToTarget) / totalDistanceToTarget + 0.2);
//
...
////                        + 0.0644448 * Math.abs(odometry.yVelocity) + 0.0179835);
////
////        // try to reverse and make negative?        double x1 = targetX - (odometry.x + currentXVel*5);
