...
//    DrivePowers calculateDrivePowers();
//
...
////        }
////
////        return fieldVectorToLocalWheelPowers(x, y);
////    };
//
...
////        return DriveVectors.fieldVectorToLocalWheelPowers(
...
//     */
//    DriveCorrection stopAtTarget = () -> new Vector(
//       (Target.xError - PinpointLocalizer.xBrakingDistance) * TuningConstants.HOLDING_PROPORTIONAL_CONSTANT,
//       (Target.yError - PinpointLocalizer.yBrakingDistance) * TuningConstants.HOLDING_PROPORTIONAL_CONSTANT
//    ).fieldVectorToLocalWheelPowers();
//
//    DriveCorrection proportional = () -> new Vector(
...
////    );
//
////    DriveVectors DrivePowers = ;
////    DriveCorrection fullPowerWithBrakingCorrectionUpScale = () -> DrivePowers.fieldVectorToLocalWheelPowers(
////        Vector.scaleToMax(
